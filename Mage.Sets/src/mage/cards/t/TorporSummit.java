...
public final class TorporSummit extends CardImpl {
    ...
    public TorporSummit(UUID ownerId, CardSetInfo setInfo) {
        ...
        Ability a = new BeginningOfUpkeepTriggeredAbility(new DoIfCostPaid(new SearchLibraryPutInPlayEffect(new TargetCardInLibrary(filter)), new SacrificeSourceCost()), TargetController.SOURCE_CONTROLLER, true);
        this.addAbility(a);
    }
